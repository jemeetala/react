...
import SignupmodalModal from "modals/Signupmodal";
...
const EduvifirstPage = () => {
  ...
  const [isOpenSignupmodalModal, setSignupmodalModal] = React.useState(false);
  ...
  function handleOpenSignupmodalModal() {
    setSignupmodalModal(true);
  }
  function handleCloseSignupmodalModal() {
    setSignupmodalModal(false);
  }
  ...
  return (
    <>
              ...
              <Row className="items-center justify-start w-[100%]">
                ...
                <header className="ml-[100px] 3xl:ml-[120px] lg:ml-[77px] xl:ml-[88px] w-[83%]">
                  <Row className="items-center justify-between w-[100%]">
                    ...
                    <Row className="items-center justify-between lg:ml-[154px] xl:ml-[176px] ml-[198px] 3xl:ml-[237px] w-[17%]">
                      <Text
                        className="common-pointer font-medium my-[10px] 3xl:my-[12px] lg:my-[7px] xl:my-[8px] lg:text-[12px] xl:text-[14px] text-[16px] 3xl:text-[19px] text-center text-deep_purple_A200 w-[auto]"
                        onClick={handleOpenLoginModal}
                      >{`Log in`}</Text>
                      <Button
                        className="common-pointer bg-deep_purple_A200 font-medium lg:ml-[18px] xl:ml-[21px] ml-[24px] 3xl:ml-[28px] lg:py-[13px] xl:py-[15px] py-[17px] 3xl:py-[20px] rounded-radius10 lg:text-[12px] xl:text-[14px] text-[16px] 3xl:text-[19px] text-center text-white_A700 w-[60%]"
                        onClick={handleOpenSignupmodalModal}
                      >{`Sign Up`}</Button>
                    </Row>
                  </Row>
                </header>
      ...
      {isOpenSignupmodalModal ? (
        <SignupmodalModal
          isOpen={isOpenSignupmodalModal}
          onRequestClose={handleCloseSignupmodalModal}
        />
      ) : null}
      {isOpenLoginModal ? (
        <LoginModal
